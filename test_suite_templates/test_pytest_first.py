...
def verify(test_case, request_id):
    ...
    if test_case == test_case_id:
        if request_id == "req1":
            ...
            # TODO: HERE IS YOUR CODE TO PREDEFINE ALL TEST CASE VERIFICATION
            # example:
            ## asserttion of application state, element in database, etc.
            return ''
...
class test_class_name(TestCase): 
    ...
    def test_cases_name(self):
        ...
        """
        # execution
        call = list_of_all_cases(test_case_id, "req1")
        response = requests.request(call[1], call[0], headers=call[2], data=dumps(call[3]))
        # request verification
        expected_response = verify(test_case_id, "req1")
        #####################################
        ...
        response = requests.request(call[1], call[0], headers=call[2], data=dumps(call[3]))
        # verification
        expected_response = verify(test_case_id, "req2")
        #####################################
        # TODO: HERE MAY BE YOUR ASSERTIONS
        # delete this part otherwise
        # the assertions have to be based on 'expected_response' variable
        ...
        response = requests.request(call[1], call[0], headers=call[2], data=dumps(call[3]))
        # verification
        expected_response = verify(test_case_id, "req3")
        #####################################
        # TODO: HERE MAY BE YOUR ASSERTIONS
        # delete this part otherwise
        # the assertions have to be based on 'expected_response' variable

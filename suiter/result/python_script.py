...
def list_of_all_cases(test_case, request_id):
    ...
    if test_case == "test_case_001":
        ...
        if request_id == "call_1":
            ...
            method = "GET"
            header = {"Content-type": "json", "testInt": "1", "dalsiTest": "52"}
            body = "./body_files/request_1_body_23"
        elif request_id == "call_2":
            url = "https://52/GET/usr1/52/a"
            method = "GET"
            header = {"Content-Type": "application/json"}
        ...
        if request_id == "call_1":
            ...
            method = "GET"
            header = {"Content-type": "json", "testInt": "1", "dalsiTest": "4"}
            body = "./body_files/request_1_body_24"
        elif request_id == "call_2":
            url = "https://4/GET/usr1/4/b"
            method = "GET"
            header = {"Content-Type": "application/json"}
        ...
        if request_id == "call_1":
            ...
            method = "GET"
            header = {"Content-type": "json", "testInt": "1", "dalsiTest": "77"}
            body = "./body_files/request_1_body_25"
        elif request_id == "call_2":
            url = "https://77/GET/usr1/77/a"
            method = "GET"
            header = {"Content-Type": "application/json"}
...
class TestClass(TestCase): 
    ...
    def test_sequence_101(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_101", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_101", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_101", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_102(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_102", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_102", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_102", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_103(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_103", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_103", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_103", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_104(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_104", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_104", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_104", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_105(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_105", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_105", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_105", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_106(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_106", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_106", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_106", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_107(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_107", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_107", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_107", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_108(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_108", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_108", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_108", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_109(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_109", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_109", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_109", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_110(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_110", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_110", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_110", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_111(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_111", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_111", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_111", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_112(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_112", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_112", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_112", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_113(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_113", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_113", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_113", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_114(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_114", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_114", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_114", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_115(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_115", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_115", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_115", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_116(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_116", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_116", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_116", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_117(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_117", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_117", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_117", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_118(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_118", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_118", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_118", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_119(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_119", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_119", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_119", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_120(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_120", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_120", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_120", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_121(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_121", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_121", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_121", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_122(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_122", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_122", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_122", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_123(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_123", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_123", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_123", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_124(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_124", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_124", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_124", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_125(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_125", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_125", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_125", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_126(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_126", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_126", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_126", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_127(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_127", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_127", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_127", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_128(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_128", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_128", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_128", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_129(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_129", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_129", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_129", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_130(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_130", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_130", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_130", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_131(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_131", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_131", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_131", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_132(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_132", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_132", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_132", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_133(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_133", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_133", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_133", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_134(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_134", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_134", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_134", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_135(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_135", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_135", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_135", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_136(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_136", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_136", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_136", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_137(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_137", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_137", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_137", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_138(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_138", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_138", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_138", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_139(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_139", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_139", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_139", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_140(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_140", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_140", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_140", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_141(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_141", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_141", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_141", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_142(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_142", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_142", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_142", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_143(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_143", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_143", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_143", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_144(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_144", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_144", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_144", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_145(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_145", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_145", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_145", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_146(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_146", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_146", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_146", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_147(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_147", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_147", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_147", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_148(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_148", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_148", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_148", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_149(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_149", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_149", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_149", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
    ...
    def test_sequence_150(self):
        ...
        setup()
        ### 1. Request ###
        call = list_of_all_cases("test_case_150", "call_1")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
        verify("test_case_150", "call_1", response, call)
        ### 2. Request ###
        call = list_of_all_cases("test_case_150", "call_2")
        with open(call[3],'rb') as payload:
            response = requests.request(call[1], call[0], headers=call[2], data=payload)
